    ...
    <body style = 'background-color:#f0f1f5;'>
        <div class = "container-fluid" >
          ...
          <div class = "col-md-12" >
            ...
            <div class = "col-md-3" style = "padding-bottom : 25px; padding-top : 10px; background-color : white">
            ...
            <form action = '' method = 'POST'>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name = 'username'id="" aria-describedby="" placeholder="Username" required>
              </div>
              <div class="form-group">
            ...
            <div class = 'col-md-12'>
              <p><center><br>or Login using</center><p>
            </div>
            <div class = 'col-md-12' >
              <div class = 'col-md-2'>
            ...
            <div class = 'col-md-12'><br><br>
              <center>Don't have an account? <a href="register.php" class="">Create</a></center>
